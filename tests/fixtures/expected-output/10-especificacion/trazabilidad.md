<!--
  ...
  el inventario real del fixture aplana a 15 objetos (los 13 enumerados en el
  plan más la application y el connected system, que el parser también
  inventaría). CU-01/CU-02 corresponden a las épicas de backlog.md; en una
...
| `DEMO_CONS_ESTADOS` (constant) | CU-01, CU-02 | HU-003, HU-004 | `estados.md` | DOCUMENTADO |
